        ...
        <div class="widget-box">
            <div class="widget-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a data-toggle="tab" href="#account-ledger" id="accountLedgerTab">Reports</a>
            ...
            <div class="widget-content tab-content">
                        ...
                        <div class="col-12" id="cashInContainer">
                            <div class="row">
                                <div class="offset-4 col-2">
                                    ...
                                    <label for="receiptCustomerRadio" style="color: green;">Receiving By Customer</label>
                                </div>
                                <div class="col-2">
                                    <input type="radio" name="receiptType" id="receiptAccountRadio" receipt-type="account">
                                    <label for="receiptAccountRadio" style="color: green;">Receiving By Dasti</label>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="col-12" id="cashOutContainer">
                            <div class="row">
                                <div class="offset-4 col-2">
                                    ...
                                    <label for="payInExpRadio" style="color: red;">Pay in Expense</label>
                                </div>
                                <div class="col-2">
                                    <input type="radio" name="paymentType" id="payemntDastiRadio" value="dasti"
                                           receipt-type="payDasti">
                                    <label for="payemntDastiRadio" style="color: red;">Dasti Pay</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12" style="margin-bottom: 10px;">
                                    <div class="row">
                                        <div class="form-group text-left col-3">
                                            <input class="form-control" type="date" name="_date" id="_date"
                                                   required>
                                        </div>
                ...
                <div id="account-ledger" class="tab-pane">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <table class="table table-hover table-bordered" id="account-ledger-table" style="width: 100%">
                                <thead>
                                    <tr>
                                        <td><b>Date</b></td>
                                        
                                        <td><b>Description</b></td>
                                        <td><b>Receiving Amount</b></td>
...
<?php /**PATH D:\xampp\htdocs\accountApp\resources\views/site_layout/general_khata_area.blade.php ENDPATH**/ ?>