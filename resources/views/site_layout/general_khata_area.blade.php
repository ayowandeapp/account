            ...
            <div class="widget-title">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a data-toggle="tab" href="#add-source-subcategory" id="addSubCategoryTab">Add
                            Sub-category</a></li>
{{--                    <li class=""><a data-toggle="tab" href="#payments" id="paymentsTab">Payments</a></li>--}}
{{--                    <li class=""><a data-toggle="tab" href="#receipts" id="receiptsTab">Receivings</a></li>--}}
                    {{-- <li class=""><a data-toggle="tab" href="#general-voucher"
                            id="generalVoucherTab">General Voucher</a>
                    <li class=""><a data-toggle="tab" href="#account-ledger" id="accountLedgerTab">Ledgers</a>
                        --}}
                    </li>
                </ul>
            </div>
                        ...
                        <div class="col-4">
                            ...
                            {{-- <div class="form-group text-left">
                                ...
                                <input type="text" class="form-control" name="registration_no" id="registration_no"
                                    placeholder="Please Enter Customer Registration No!" autofocus>
                            </div> --}}
                            <div class="form-group text-right">
                            ...
                            <div class="row">
                                <div class="form-group text-left col-2">
                                    <select name="debit_acc" id="debit_acc" class="form-control" required>
                                        ...
                                        @if (isset($accounts))
                                            @foreach ($accounts as $account)
                                                <option value="{{ $account->id }}">{{ $account->acc_name }}
                                                </option>
                                            @endforeach
                                        @endif
                                ...
                                <div class="form-group text-left col-2">
                                    {{-- <label
                                        for="receipt_description">Description</label> --}}
