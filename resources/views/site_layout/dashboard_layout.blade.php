...
<head>
    ...
    --}}
    <link rel="stylesheet" href="{{ asset('site_assets/css/bootstrap-4-4-1.min.css') }}">

    <link rel="stylesheet" href="{{ asset('site_assets/css/fullcalendar.css') }}" />
    {{--
    <link rel="stylesheet" href="{{ asset('site_assets/css/datatable.css') }}" /> --}}
    <link rel="stylesheet" href="{{ asset('site_assets/pluginns/jqueryDataTables.min.css') }}">
    <link href="{{ asset('pluginns/fontawesome4-7.min.css') }}" rel="stylesheet">

    <link rel="stylesheet" href="{{ asset('pluginns/select2.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('site_assets/css/maruti-style.css') }}" />
    <link rel="stylesheet" href="{{ asset('site_assets/css/maruti-media.css') }}" class="skin-color" />
    <style>
...
<body style="background: url({{ asset('site_assets/images/backgrounds/bodyBg.png') }}) repeat #fff;">
    ...
    @include('modals.edit_cashin_dasti')
    @include('modals.edit_cashout')
    @include('site_layout.footer')
    <script src="{{ asset('site_assets/js/sweet-alert.js') }}"></script>
    <script>
        ...
        function getPaymentReceiptBalance() {
            ...
            $.ajax({
                url: "{{ route('get.payment.receipt.balance') }}",
                type: "POST",
                success: function(response) { // What to do if we succeed
        ...
        $(document).delegate('.subcategories-list-tr', 'click', function() {
            ...
            $.ajax({
                url: "{{ route('get.subcategory.ledger') }}",
                type: "POST",
                data: {
        ...
        $(document).delegate('#payemntDastiRadio, #generalKhataPointTab', 'click', function() {
            $.ajax({
                url: "{{ route('get.all.account.get.option') }}",
                type: "POST",
                success: function(response) { // What to do if we succeed
            ...
            if(receiptNewDescription != '' && receiptNewDescription != null && receiptNewDateUpdate != '' && receiptNewDateUpdate != null && receiptNewAmount != '' && receiptNewAmount != null){
                ...
                if(type == 'dasti'){
                    ...
                    DateToRequest = {
                        ...
                        receipt_date: receiptNewDateUpdate,
            ...
            if(paymentNewDescription != '' && paymentNewDescription != null && paymentNewDateUpdate != '' && paymentNewDateUpdate != null && paymentNewAmount != '' && paymentNewAmount != null){
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        payment_date: paymentNewDateUpdate,
